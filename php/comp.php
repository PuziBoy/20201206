<br>
<div class = "container" id="comp" style="background-color:	#DCDBDB">
  <h2><?php echo $terms['computer'] ?></h2>
<div class = "row">

<?php
  $compServices = mysqli_query($link, "SELECT code, theText, title, photo  FROM services WHERE lead = 1 AND lang = '$pageLang'");
  $compArray = array();
